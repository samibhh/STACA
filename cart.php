...
?>
 <tr>
                                                <td>Product</td>
                                                <td> <input class="form-control" name="ref" value="<?php echo $row['idproduit']; ?>" readonly></td>
                                              </tr>
                                              <tr>
                                                <td>Total</td>
                                               <td> <input  class="form-control" name="price" value="<?php echo $row['prixtotale']; ?>" readonly></td>

                                              </tr>
                                                         <tr>
                                                <td>Quantity</td>
                                               <td><input  class="form-control" type="text" name="idc"  value="<?php echo $row['quantite']; ?>" readonly></td>
...
<?php } ?>
        ...
        <td><input class="form-control" type="text" name="adress" required ></td>
    </tr>
  </div>
...
<!--
    ...
    -->  
        ...
        <td><input  class="form-control" type="number" name="phone" min="20000000" max="99999999" required ></td>
    </tr>
